...
<body>
  ...
  <main id="main">
    ...
    <div class="container seccionModificable" id="formulario">
        <form action="algo.php" method="POST" autocomplete="off" class="row justify-content-center" id="formContratacion">
            ...
            <div class="col-sm-12">
                <fieldset class="DatoContratacion">
                    ...
                    <select name="Salon" class="form-control form-select" id="salon" required>
                        ...
                        <option value="Jardín de eventos">Jardin de eventos</option>
                    </select>
                    <br>
                    ...
                    <div id="otroMenu" style="display: none;">
                        ...
                        <fieldset class="MenuPersonal">
                            ...
                            <select name="entradas" id="entradaMenu" class="form-control form-select">
                                <option value="">--SELECCIONA UNA OPCION--</option>
                                <option value="BocadillosMole">Bocadillos de pollo con Mole</option>
                                <option value="Bruschettas">Bruschettas de champiñones</option>
                                <option value="Canelones">Canelones de salchicha y queso</option>
                            </select>
                            <br><br>
                            <label for="platoFuerte">Plato Fuerte: </label>
                            <select name="platoFuerte" id="fuerteMenu" class="form-control form-select">
                                <option value="">--SELECCIONA UNA OPCION--</option>
                                <option value="Pechugas">Pechugas de pollo a la Cordon Bleu</option>
                                <option value="LomoCerdo">Lomo de cerdo en salsa BBQ</option>
                                <option value="Pozole">Pozole o Menudo</option>
                            </select>
                            <br><br>
                            <label for="postre">Postre: </label>
                            <select name="postre" id="postreMenu" class="form-control form-select">
                                <option value="">--SELECCIONA UNA OPCION--</option>
                                <option value="Churros">Churros con chocolate</option>
                                <option value="Pastel">Pastel rayado de chocolate</option>
                                <option value="Duraznos">Duraznos en rompope</option>
                            </select>
                        </fieldset>
                    </div>
                </fieldset>
      ...
      <div class="container seccionModificable show" id="lecturaRegistro" style="display: none;">
        <div class="row">
          <form action="#">
            <fieldset>
              <legend>Búsqueda de registro: </legend>
              <div class="form-check form-check-inline radioDiv">
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="busquedaCURP" value="curp" checked>
                <label class="form-check-label" for="busquedaCURP">Búsqueda por CURP: </label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="busquedaFecha" value="option2">
                <label class="form-check-label" for="busquedaFecha">Búsqueda por Fecha:</label>
              </div>
              <!--Buscar por CURP-->
              <div class="form-floating mb-3 busquedaDiv" id="busquedaPorCurp">
                <input type="text" class="form-control" id="curpABuscar" placeholder="Ingrese el CURP">
                <label for="curpABuscar">CURP registrado</label>
              </div>
              <!--Buscar por fecha-->
              <div class="form-floating mb-3 busquedaDiv" id="busquedaPorFecha">
                <input type="date" class="form-control" id="fechaABuscar" placeholder="Ingrese la fecha">
