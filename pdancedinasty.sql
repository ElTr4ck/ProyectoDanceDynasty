...
-- Tiempo de generación: 27-06-2023 a las 02:04:32
...
INSERT INTO `contratacion` (`Nombre(s)`, `ApellidoP`, `ApellidoM`, `Curp`, `Email`, `Telefono`, `Calle`, `CodigoP`, `NoE`, `NoI`, `EntidadF`, `Municipio`, `Colonia`, `Salon`, `FechaE`, `DiaE`, `NoPer`, `TipoE`, `OtroE`, `Menu`, `Entrada`, `Fuerte`, `Postre`) VALUES
